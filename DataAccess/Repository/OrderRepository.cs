...
namespace DataAccess.Repository
{
    public class OrderRepository : BaseRepository<Order>
    {
        ...
        public IList<Order> Search(DateTime starDateTime, DateTime endDateTime, string id)
        {
            using var Context = DbContext as SaleContext;
...
.OrderByDescending(entity => entity.OrderDate).ToList();
                ...
                return Context.Orders.Include("OrderDetails")
                .Where(entity => (entity.MemberId.ToString().Equals(id) &&entity.OrderDate >= starDateTime && entity.OrderDate <= endDateTime))
                .OrderByDescending(entity => entity.OrderDate).ToList();
